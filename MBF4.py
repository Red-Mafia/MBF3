...
# coding=utf-8
# Coded By RED-MAFIA
# My Facebook ( https://www.facebook.com/R.k.Riazkhan.termux.tool.owner )
...
# LO KONTOL
logo = ''' 
\033[0;96m ██▀███      ██ ▄█▀  ® \033[0m|| Created By RED-MAFIA
\033[0;95m▓██ ▒ ██▒    ██▄█▒   ® \033[0m|| FB  :RED-MAFIA(RK)
\033[0;94m▓██ ░▄█ ▒   ▓███▄░  ® \033[0m|| WA:+923188214452
\033[0;93m▒██▀▀█▄     ▓██ █▄     ® \033[0m|| INSTA: NAHI HAI
\033[0;92m░██▓ ▒██▒   ▒██▒ █▄  ® \033[0m|| TEAM :RED-MAFIA
\033[0;91m░ ▒▓ ░▒▓░   ▒ ▒▒ ▓▒     ® \033[0m|| Created By ALI RAZA
\033[0;96m  ░▒ ░ ▒░   ░ ░▒ ▒░  ® \033[0m|| ADMIN:RK AND ALI
\033[0;97m  ░░   ░    ░ ░░ ░        ® \033[0m|| CODED BY RED-MAFIA
\033[0;92m   ░        ░  ░                   ® \033[0m|| CODED BY ALI RAZA 
'''
...
def info_tools():
    ...
    print '\n %s[%s>%s] Author   : RED-MAFIA AND ALI RAZA'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Red-Mafia'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/R.k.Riazkhan.termux.tool.owner'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/R.k.Riazkhan.termux.tool.owner'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Watsapp: https://wa.me/+923188214452'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Website  : https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi'%(N,H,N);time.sleep(0.07)
